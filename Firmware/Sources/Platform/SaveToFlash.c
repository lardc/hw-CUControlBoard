...
void STF_Save(Boolean Readable)
{
	...
	for(i = 0; i < StorageSize; i++)
	{
		...
		// «апись данных при наличии указател€
		if(TablePointers[i])
		{
...
Int16U STF_StartAddressShift(Int16U Index, Boolean Readable)
{
	...
	for(i = 0; i < Index; i++)
	{
		...
		{
			// Ќа каждую запись выдел€етс€ дополнительно:
			// 2 пол€ дл€ хранени€ типа и длины описани€
			// 2 пол€ дл€ хранени€ типа и длины самих данных
